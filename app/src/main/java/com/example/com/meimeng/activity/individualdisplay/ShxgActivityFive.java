 ...
 * 生活习惯5
 */
public class ShxgActivityFive extends BaseActivity {
 ...
 * 区别改动区域
 */
        thistype = 2;//记录是属于哪一类的问题
        questionHashMap = GetDbUtils.getQuestionHashMap(ShxgActivityFive.this, thistype);
        //这部分只是界面展示用的
        thisqid = 11;
        question_title.setText("5/5" + questionHashMap.get(thisqid));
        answerHashMap = GetDbUtils.getAnswerHashMap(ShxgActivityFive.this, thisqid);
    ...
    void gotonext() {
        ...
        individualJsonBean.setLstUserAnswer(MeiMengApplication.shxgLstUserAnswer);
        Gson gson = new Gson();
    ...
    void jumpnext() {
        for (Activity activity : MeiMengApplication.ShxgManageActivity) {
            activity.finish();
        }
    }
                    ...
                    .subscribe(new Action1() {
                        ...
                        public void call(Object o) {
                            ...
                            if (basebean.isSuccess()) {
                                Toast.makeText(ShxgActivityFive.this, "提交成功", Toast.LENGTH_SHORT).show();
                                for (Activity activity : MeiMengApplication.ShxgManageActivity) {
                                    activity.finish();
                                }
                            } else {
                                DialogUtils.setDialog(ShxgActivityFive.this, basebean.getError());
                            }
                        }
                        ...
                        public void call(Throwable throwable) {
                            Log.e("ShxgActivityFive", throwable.getMessage());
                        }
                    });
        } catch (Exception e) {
            e.printStackTrace();
