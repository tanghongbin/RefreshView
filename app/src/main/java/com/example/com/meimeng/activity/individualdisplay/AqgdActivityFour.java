 ...
 * 爱情观点4
 */
public class AqgdActivityFour extends BaseActivity {
 ...
 */
        thistype = 3;
        questionHashMap = GetDbUtils.getQuestionHashMap(AqgdActivityFour.this, thistype);
        //这部分只是界面展示用的
        thisqid = 15;
        question_title.setText("4/5" + questionHashMap.get(thisqid));
        answerHashMap = GetDbUtils.getAnswerHashMap(AqgdActivityFour.this, thisqid);
    ...
    void gotonext() {
        ...
        Intent intent = new Intent(this, AqgdActivityFive.class);
