 ...
 * 婚姻期望1
 */
public class HyqwActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MeiMengApplication.hyqwLstUserAnswer.clear();
 ...
 */
        thistype = 5;
        questionHashMap = GetDbUtils.getQuestionHashMap(HyqwActivity.this, thistype);
        //这部分只是界面展示用的
        thisqid = 23;
        question_title.setText("1/5" + questionHashMap.get(thisqid));
        answerHashMap = GetDbUtils.getAnswerHashMap(HyqwActivity.this, thisqid);
    ...
    void gotonext() {
        ...
        Intent intent = new Intent(this, HyqwActivityTwo.class);
