 ...
 * 个性描述2
 */
public class GxmsActivityTwo extends BaseActivity {
 ...
 */
        thistype = 1;
        questionHashMap = GetDbUtils.getQuestionHashMap(GxmsActivityTwo.this, thistype);
        //这部分只是界面展示用的
        thisqid = 3;
        question_title.setText("2/5" + questionHashMap.get(thisqid));
        answerHashMap = GetDbUtils.getAnswerHashMap(GxmsActivityTwo.this, thisqid);
    ...
    void gotonext() {
        ...
        Intent intent = new Intent(this, GxmsActivityThree.class);
