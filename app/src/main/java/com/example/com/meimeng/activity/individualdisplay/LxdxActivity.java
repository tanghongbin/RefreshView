 ...
 * 理想对象1
 */
public class LxdxActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MeiMengApplication.lxdxLstUserAnswer.clear();
    ...
    private void initView() {
         ...
         */
        thistype = 7;
        questionHashMap = GetDbUtils.getQuestionHashMap(LxdxActivity.this, thistype);
        ...
        answerHashMap = GetDbUtils.getAnswerHashMap(LxdxActivity.this, thisqid);
    ...
    void gotonext() {
        ...
        Intent intent = new Intent(this, LxdxActivityTwo.class);
