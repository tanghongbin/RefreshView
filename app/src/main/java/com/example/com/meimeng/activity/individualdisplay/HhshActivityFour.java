 ...
 * 婚后生活4
 */
public class HhshActivityFour extends BaseActivity {
 ...
 */
        thistype = 6;
        questionHashMap = GetDbUtils.getQuestionHashMap(HhshActivityFour.this, thistype);
        //这部分只是界面展示用的
        thisqid = 32;
        question_title.setText("4/5" + questionHashMap.get(thisqid));
        answerHashMap = GetDbUtils.getAnswerHashMap(HhshActivityFour.this, thisqid);
    ...
    void gotonext() {
        ...
        Intent intent = new Intent(this, HhshActivityFive.class);
