 ...
 * 生活习惯2
 */
public class ShxgActivityTwo extends BaseActivity {
 ...
 */
        thistype = 2;
        questionHashMap = GetDbUtils.getQuestionHashMap(ShxgActivityTwo.this, thistype);
        //这部分只是界面展示用的
        thisqid = 8;
        question_title.setText("2/5" + questionHashMap.get(thisqid));
        answerHashMap = GetDbUtils.getAnswerHashMap(ShxgActivityTwo.this, thisqid);
    ...
    void gotonext() {
        ...
        Intent intent = new Intent(this, ShxgActivityThree.class);
