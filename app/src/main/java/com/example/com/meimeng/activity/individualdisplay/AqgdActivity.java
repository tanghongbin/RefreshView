 ...
 * 爱情观点1
 */
public class AqgdActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MeiMengApplication.aqgdLstUserAnswer.clear();
 ...
 */
        thistype = 3;
        questionHashMap = GetDbUtils.getQuestionHashMap(AqgdActivity.this, thistype);
        //这部分只是界面展示用的
        thisqid = 12;
        question_title.setText("1/5" + questionHashMap.get(thisqid));
        answerHashMap = GetDbUtils.getAnswerHashMap(AqgdActivity.this, thisqid);
    ...
    void gotonext() {
        ...
        Intent intent = new Intent(this, AqgdActivityTwo.class);
