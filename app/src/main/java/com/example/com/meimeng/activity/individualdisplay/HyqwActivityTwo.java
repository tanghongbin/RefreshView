 ...
 * 婚姻期望2
 */
public class HyqwActivityTwo extends BaseActivity {
 ...
 */
        thistype = 5;
        questionHashMap = GetDbUtils.getQuestionHashMap(HyqwActivityTwo.this, thistype);
        //这部分只是界面展示用的
        if (sex == 1) {
            thisqid = 24;
        } else {
        ...
        question_title.setText("2/5" + questionHashMap.get(thisqid));
        answerHashMap = GetDbUtils.getAnswerHashMap(HyqwActivityTwo.this, thisqid);
    ...
    void gotonext() {
        ...
        Intent intent = new Intent(this, HyqwActivityThree.class);
