 ...
 * 婚姻期望4
 */
public class HyqwActivityFour extends BaseActivity {
 ...
 */
        thistype = 5;
        questionHashMap = GetDbUtils.getQuestionHashMap(HyqwActivityFour.this, thistype);
        //这部分只是界面展示用的
        thisqid = 27;
        question_title.setText("4/5" + questionHashMap.get(thisqid));
        answerHashMap = GetDbUtils.getAnswerHashMap(HyqwActivityFour.this, thisqid);
    ...
    void gotonext() {
        ...
        Intent intent = new Intent(this, HyqwActivityFive.class);
