 ...
 * 理想对象5
 */
public class LxdxActivityFive extends BaseActivity {
...
/**
 * 区别改动区域
 */thistype = 7;//记录是属于哪一类的问题
        questionHashMap = GetDbUtils.getQuestionHashMap(LxdxActivityFive.this, thistype);
        //这部分只是界面展示用的
        if (sex == 1) {
            thisqid = 39;
        } else {
        ...
        answerHashMap = GetDbUtils.getAnswerHashMap(LxdxActivityFive.this, thisqid);
    ...
    void gotonext() {
        ...
        individualJsonBean.setLstUserAnswer(MeiMengApplication.lxdxLstUserAnswer);
        Gson gson = new Gson();
    ...
    void jumpnext() {
        for (Activity activity : MeiMengApplication.LxdxManageActivity) {
            activity.finish();
        }
    }
                    ...
                    .subscribe(new Action1() {
                        ...
                        public void call(Object o) {
                            ...
                            if (basebean.isSuccess()) {
                                Toast.makeText(LxdxActivityFive.this, "提交成功", Toast.LENGTH_SHORT).show();
                                for (Activity activity : MeiMengApplication.LxdxManageActivity) {
                                    activity.finish();
                                }
                            } else {
                                DialogUtils.setDialog(LxdxActivityFive.this, basebean.getError());
                            }
                        }
                        ...
                        public void call(Throwable throwable) {
                            Log.e("LxdxActivityFive", throwable.getMessage());
                        }
                    });
        } catch (Exception e) {
            e.printStackTrace();
