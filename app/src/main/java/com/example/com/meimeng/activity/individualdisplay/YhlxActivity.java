 ...
 * 约会类型1
 */
public class YhlxActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MeiMengApplication.yhlxLstUserAnswer.clear();
 ...
 */
        thistype = 4;
        questionHashMap = GetDbUtils.getQuestionHashMap(YhlxActivity.this, thistype);
            thisqid = 17;
        //这部分只是界面展示用的
//        thisqid = 17;
        question_title.setText("1/5" + questionHashMap.get(thisqid)+ "（多选）");
        answerHashMap = GetDbUtils.getAnswerHashMap(YhlxActivity.this, thisqid);
    ...
    void gotonext() {
        ...
        Intent intent = new Intent(this, YhlxActivityTwo.class);
