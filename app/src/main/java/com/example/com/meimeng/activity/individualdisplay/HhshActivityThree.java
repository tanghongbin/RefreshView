 ...
 * 婚后生活3
 */
public class HhshActivityThree extends BaseActivity {
 ...
 */
        thistype = 6;
        questionHashMap = GetDbUtils.getQuestionHashMap(HhshActivityThree.this, thistype);
        //这部分只是界面展示用的
        thisqid = 31;
        question_title.setText("3/5" + questionHashMap.get(thisqid));
        answerHashMap = GetDbUtils.getAnswerHashMap(HhshActivityThree.this, thisqid);
    ...
    void gotonext() {
        ...
        Intent intent = new Intent(this, HhshActivityFour.class);
