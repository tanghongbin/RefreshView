 ...
 * 婚姻期望3
 */
public class HyqwActivityThree extends BaseActivity {
 ...
 */
        thistype = 5;
        questionHashMap = GetDbUtils.getQuestionHashMap(HyqwActivityThree.this, thistype);
        //这部分只是界面展示用的
        thisqid = 26;
        question_title.setText("3/5" + questionHashMap.get(thisqid));
        answerHashMap = GetDbUtils.getAnswerHashMap(HyqwActivityThree.this, thisqid);
    ...
    void gotonext() {
        ...
        Intent intent = new Intent(this, HyqwActivityFour.class);
