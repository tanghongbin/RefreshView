 ...
 * 理想对象4
 */
public class LxdxActivityFour extends BaseActivity {
 ...
 */
        thistype = 7;
        questionHashMap = GetDbUtils.getQuestionHashMap(LxdxActivityFour.this, thistype);
        //这部分只是界面展示用的
        thisqid = 38;
        question_title.setText("4/5" + questionHashMap.get(thisqid));
        answerHashMap = GetDbUtils.getAnswerHashMap(LxdxActivityFour.this, thisqid);
    ...
    void gotonext() {
        ...
        Intent intent = new Intent(this, LxdxActivityFive.class);
