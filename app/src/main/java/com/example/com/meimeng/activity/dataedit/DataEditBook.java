 ...
 */
public class DataEditBook extends BaseActivity {
 ...
 * 区别改动区域
 */
        masterHashMap = GetDbUtils.getMsterHashMap(DataEditBook.this, 44);
    ...
    void suretext() {
        ...
        DataEditBook.this.setResult(14, intent);
        //关闭Activity
        DataEditBook.this.finish();
    }
