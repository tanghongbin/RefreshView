 ...
 */
public class DataEditMovie extends BaseActivity {
 ...
 * 区别改动区域
 */
        masterHashMap = GetDbUtils.getMsterHashMap(DataEditMovie.this, 46);
    ...
    void suretext() {
        ...
        if (isSelectMap.size()>9) {
            Utils.setPromptDialog(DataEditMovie.this, "最多只能选择9项！");
        }else{
            ...
            DataEditMovie.this.setResult(13, intent);
            //关闭Activity
            DataEditMovie.this.finish();
        }
    }
