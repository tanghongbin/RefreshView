 ...
 */
public class DataEditMusic extends BaseActivity {
 ...
 * 区别改动区域
 */
        masterHashMap = GetDbUtils.getMsterHashMap(DataEditMusic.this, 45);
    ...
    void suretext() {
        ...
        DataEditMusic.this.setResult(11, intent);
        //关闭Activity
        DataEditMusic.this.finish();
    }
