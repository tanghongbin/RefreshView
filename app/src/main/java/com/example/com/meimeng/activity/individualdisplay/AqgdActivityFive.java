 ...
 * 爱情观点5
 */
public class AqgdActivityFive extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MeiMengApplication.AqgdManageActivity.add(this);
        button.setText("提交修改");
...
/**
 * 区别改动区域
 */thistype = 3;//记录是属于哪一类的问题
        questionHashMap = GetDbUtils.getQuestionHashMap(AqgdActivityFive.this, thistype);
        //这部分只是界面展示用的
        thisqid = 16;
        question_title.setText("5/5" + questionHashMap.get(thisqid));
        answerHashMap = GetDbUtils.getAnswerHashMap(AqgdActivityFive.this, thisqid);
    ...
    void gotonext() {
        ...
        if (!hasselectedbefore) {
            MeiMengApplication.aqgdLstUserAnswer.add(lstUserAnswer);
        }
        hasselectedbefore = true;
        IndividualJsonBean individualJsonBean = new IndividualJsonBean();
        individualJsonBean.setLstUserAnswer(MeiMengApplication.aqgdLstUserAnswer);
        Gson gson = new Gson();
    ...
    void jumpnext() {
        for (Activity activity : MeiMengApplication.AqgdManageActivity) {
            activity.finish();
        }
    }
                    ...
                    .subscribe(new Action1() {
                        ...
                        public void call(Object o) {
                            ...
                            if (basebean.isSuccess()) {
                                Toast.makeText(AqgdActivityFive.this, "提交成功", Toast.LENGTH_SHORT).show();
                                for (Activity activity : MeiMengApplication.AqgdManageActivity) {
                                    activity.finish();
                                }
                            } else {
                                DialogUtils.setDialog(AqgdActivityFive.this, basebean.getError());
                            }
                        }
                        ...
                        public void call(Throwable throwable) {
                            Log.e("AqgdActivityFive", throwable.getMessage());
                        }
                    });
        } catch (Exception e) {
            e.printStackTrace();
    ...
    protected void onDestroy() {
        super.onDestroy();
        //将答案从list中移除
        MeiMengApplication.aqgdLstUserAnswer.remove(lstUserAnswer);
        MeiMengApplication.AqgdManageActivity.remove(this);
    }
}
