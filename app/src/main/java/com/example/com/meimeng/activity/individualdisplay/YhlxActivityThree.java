 ...
 */
        thistype = 4;
        questionHashMap = GetDbUtils.getQuestionHashMap(YhlxActivityThree.this, thistype);
        //这部分只是界面展示用的
        if (sex == 1) {
            thisqid = 19;
        } else {
        ...
        answerHashMap = GetDbUtils.getAnswerHashMap(YhlxActivityThree.this, thisqid);
    ...
    void gotonext() {
        ...
        Intent intent = new Intent(this, YhlxActivityFour.class);
