 ...
 * 个性描述3
 */
public class GxmsActivityThree extends BaseActivity {
 ...
 */     thistype=1;//记录是属于哪一类的问题
        questionHashMap = GetDbUtils.getQuestionHashMap(GxmsActivityThree.this, thistype);
        //这部分只是界面展示用的
        thisqid=4;
        question_title.setText("3/5" + questionHashMap.get(thisqid));
        answerHashMap = GetDbUtils.getAnswerHashMap(GxmsActivityThree.this, thisqid);
    ...
    void gotonext() {
        ...
        Intent intent = new Intent(this, GxmsActivityFour.class);
