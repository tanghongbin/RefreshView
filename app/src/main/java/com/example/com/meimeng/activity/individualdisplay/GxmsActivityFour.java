 ...
 * 个性描述4
 */
public class GxmsActivityFour extends BaseActivity {
 ...
 */     thistype=1;//记录是属于哪一类的问题
        questionHashMap = GetDbUtils.getQuestionHashMap(GxmsActivityFour.this, thistype);
        //这部分只是界面展示用的
        thisqid=5;
        question_title.setText("4/5" + questionHashMap.get(thisqid));
        answerHashMap = GetDbUtils.getAnswerHashMap(GxmsActivityFour.this, thisqid);
    ...
    void gotonext() {
        ...
        Intent intent = new Intent(this, GxmsActivityFive.class);
