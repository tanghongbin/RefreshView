 ...
 */
public class DataEditTravel extends BaseActivity {
 ...
 * 区别改动区域
 */
        masterHashMap = GetDbUtils.getMsterHashMap(DataEditTravel.this, 50);
    ...
    void suretext() {
        ...
        if (isSelectMap.size()>9) {
            Utils.setPromptDialog(DataEditTravel.this, "最多只能选择9项！");
        }else{
            ...
            DataEditTravel.this.setResult(15, intent);
            //关闭Activity
            DataEditTravel.this.finish();
        }
    }
