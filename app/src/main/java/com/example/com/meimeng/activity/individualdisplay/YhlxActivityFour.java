 ...
 * 约会类型4
 */
public class YhlxActivityFour extends BaseActivity {
 ...
 */
        thistype = 4;
        questionHashMap = GetDbUtils.getQuestionHashMap(YhlxActivityFour.this, thistype);
        //这部分只是界面展示用的
        thisqid = 21;
        question_title.setText("4/5" + questionHashMap.get(thisqid));
        answerHashMap = GetDbUtils.getAnswerHashMap(YhlxActivityFour.this, thisqid);
    ...
    void gotonext() {
        ...
        Intent intent = new Intent(this, YhlxActivityFive.class);
