 ...
 * 理想对象2
 */
public class LxdxActivityTwo extends BaseActivity {
    ...
    private void initView() {
         ...
         */
        thistype = 7;
        questionHashMap = GetDbUtils.getQuestionHashMap(LxdxActivityTwo.this, thistype);
        thisqid = 36;
        question_title.setText("2/5" + questionHashMap.get(thisqid)+"（多选）");
        answerHashMap = GetDbUtils.getAnswerHashMap(LxdxActivityTwo.this, thisqid);
    ...
    void gotonext() {
        ...
        Intent intent = new Intent(this, LxdxActivityThree.class);
