 ...
 * 爱情观点2
 */
public class AqgdActivityTwo extends BaseActivity {
 ...
 */
        thistype = 3;
        questionHashMap = GetDbUtils.getQuestionHashMap(AqgdActivityTwo.this, thistype);
        //这部分只是界面展示用的
        thisqid = 13;
        question_title.setText("2/5" + questionHashMap.get(thisqid));
        answerHashMap = GetDbUtils.getAnswerHashMap(AqgdActivityTwo.this, thisqid);
    ...
    void gotonext() {
        ...
        Intent intent = new Intent(this, AqgdActivityThree.class);
