 ...
 * 婚后生活2
 */
public class HhshActivityTwo extends BaseActivity {
 ...
 */
        thistype = 6;
        questionHashMap = GetDbUtils.getQuestionHashMap(HhshActivityTwo.this, thistype);
        //这部分只是界面展示用的
        thisqid = 30;
        question_title.setText("2/5" + questionHashMap.get(thisqid));
        answerHashMap = GetDbUtils.getAnswerHashMap(HhshActivityTwo.this, thisqid);
    ...
    void gotonext() {
        ...
        Intent intent = new Intent(this, HhshActivityThree.class);
