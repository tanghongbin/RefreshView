 ...
 */
public class IdentifyMoneyActivity extends BaseActivity {
    private static final String TAG = "IdentifyMoneyActivity";
...
//    TextView describe1Text;
    ...
    private ArrayList<Long> picIdList;
    ...
    private void initView() {
        ...
        describeImageView.setImageResource(R.drawable.icon_money);
//        describe1Text.setText("资产认证");
//        describe2Text.setText("请点击上传本人资产证明（最少一张），可以是房产证、购车证明、企业法人证明、银行现金证明等。上传的认证资料将经过验证系统加密处理，以保证个人信息不被泄露，请放心上传。");
        describe2Text.setText("请点击上传本人资产证明，可以是房产证、购车证明、企业法人证明、银行现金证明等。您上传的资料将经过系统加密处理，保障个人信息安全，请放心上传。");
        describe3Text.setText("点击上传");
        titleText.setText("资产认证");
        ...
        Utils.readBitMap(IdentifyMoneyActivity.this, mBgExample, R.raw.identify_money);
        initImageView();
    }
    ...
    private void initImageView() {
        //如果有网
        if (InternetUtils.isNetworkConnected(IdentifyMoneyActivity.this)) {
                        ...
                        .subscribe(new Action1() {
                            ...
                            public void call(Object o) {
                                ...
                                if (certificateStatusBean.isSuccess()) {
                                    ...
                                    DialogUtils.setDialog(IdentifyMoneyActivity.this, certificateStatusBean.getError());
    ...
    private void initWedget(CertificateStatusBean certificateStatusBean) {
        ...
        if (certificateStatusBean.getParam().getStatus().getPropertyPicId() != null) {
                //已经上传了照片，正在审核中，也不能再上传照片了，点击无效
                List<Long> pics=certificateStatusBean.getParam().getStatus().getPropertyPicId() ;
            ...
            switch (certificateStatusBean.getParam().getStatus().getPropertyPicId().size()) {
                case 1:
                    ...
                    if (certificateStatusBean.getParam().getStatus().getPropertyStatus() == HASCERTIFICATE) {
                        setButton(certificateStatusBean);
                        describe3Text.setText("审核通过");
                        picId_0 = certificateStatusBean.getParam().getStatus().getPropertyPicId().get(0);
                    ...
                    } else if (certificateStatusBean.getParam().getStatus().getPropertyStatus() == UNCERTIFICATE) {
                ...
                case 2:
                    ...
                    if (certificateStatusBean.getParam().getStatus().getPropertyStatus() == HASCERTIFICATE) {
                        ...
                        picId_0 = certificateStatusBean.getParam().getStatus().getPropertyPicId().get(0);
                        picId_1 = certificateStatusBean.getParam().getStatus().getPropertyPicId().get(1);
                        InternetUtils.getPicIntoView(300, 100, bg_first, picId_0);
                ...
                default:
                    ...
                    if (certificateStatusBean.getParam().getStatus().getPropertyStatus() == HASCERTIFICATE) {
                        ...
                        picId_0 = certificateStatusBean.getParam().getStatus().getPropertyPicId().get(0);
                        picId_1 = certificateStatusBean.getParam().getStatus().getPropertyPicId().get(1);
                        picId_2 = certificateStatusBean.getParam().getStatus().getPropertyPicId().get(2);
                        InternetUtils.getPicIntoView(300, 100, bg_first, picId_0);
                        InternetUtils.getPicIntoView(300, 100, bg_second, picId_1);
     ...
     *
     */
    public void identifyMoney( ArrayList<Long> pidLIst) {
        try {
            //获取用户的uid,和token
            if (TextUtils.isEmpty(Utils.getUserId())) {
                return;
                        ...
                        public void call(String s) {
                            ...
                            if (basebeanJson.isSuccess()) {
                                ...
                                if (basebeanJson.getError().equals("未登录")) {
                                    DialogUtils.setDialog(IdentifyMoneyActivity.this, basebeanJson.getError());
                                }
                                displayAfterUploadfailed();
                                Toast.makeText(IdentifyMoneyActivity.this, basebeanJson.getError(), Toast.LENGTH_SHORT).show();
                            }
                        }
                    }, new Action1<Throwable>() {
                        @Override
    ...
    private void setSelectPictureDialog() {
        if (selectPictureDialog == null) {
            selectPictureDialog = new SelectPictureDialog(IdentifyMoneyActivity.this, R.style.loading_dialog);
        }
        ...
        if (data != null) {
            switch (requestCode) {
                ...
                case SelectPictureDialog.CHOOSE_BIG_PICTURE:
                    String path = ImageUtil.getPath(IdentifyMoneyActivity.this, SelectPictureDialog.imageUri);
                ...
                case CAMEAR_CROP_PICTURE:
                    String path2 = ImageUtil.getPath(IdentifyMoneyActivity.this, SelectPictureDialog.cameraUri);
                ...
                .subscribe(new Action1() {
                    ...
                    public void call(Object o) {
                        ...
                        if (bean.isSuccess()) {
                            ...
                            DialogUtils.setDialog(IdentifyMoneyActivity.this, bean.getError());
                        }
                    }
                }, new Action1<Throwable>() {
                    @Override
