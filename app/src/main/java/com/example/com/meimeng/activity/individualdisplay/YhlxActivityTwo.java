 ...
 * 约会类型2
 */
public class YhlxActivityTwo extends BaseActivity {
 ...
 */
        thistype = 4;
        questionHashMap = GetDbUtils.getQuestionHashMap(YhlxActivityTwo.this, thistype);
        //这部分只是界面展示用的
        thisqid = 18;
        question_title.setText("2/5" + questionHashMap.get(thisqid));
        answerHashMap = GetDbUtils.getAnswerHashMap(YhlxActivityTwo.this, thisqid);
    ...
    void gotonext() {
        ...
        Intent intent = new Intent(this, YhlxActivityThree.class);
