 ...
 * 婚后生活1
 */
public class HhshActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MeiMengApplication.hhshLstUserAnswer.clear();
 ...
 */
        thistype = 6;
        questionHashMap = GetDbUtils.getQuestionHashMap(HhshActivity.this, thistype);
        //这部分只是界面展示用的
        thisqid = 29;
        question_title.setText("1/5" + questionHashMap.get(thisqid));
        answerHashMap = GetDbUtils.getAnswerHashMap(HhshActivity.this, thisqid);
    ...
    void gotonext() {
        ...
        Intent intent = new Intent(this, HhshActivityTwo.class);
