 ...
 */
public class DataEditFood extends BaseActivity {
 ...
 * 区别改动区域
 */
        masterHashMap = GetDbUtils.getMsterHashMap(DataEditFood.this, 43);
    ...
    void suretext() {
        ...
        DataEditFood.this.setResult(12, intent);
        //关闭Activity
        DataEditFood.this.finish();
    }
