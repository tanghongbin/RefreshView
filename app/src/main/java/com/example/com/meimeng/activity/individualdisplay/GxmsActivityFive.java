 ...
 * 个性描述5
 */
public class GxmsActivityFive extends BaseActivity {
...
/**
 * 区别改动区域
 */thistype = 1;//记录是属于哪一类的问题
        questionHashMap = GetDbUtils.getQuestionHashMap(GxmsActivityFive.this, thistype);
        //这部分只是界面展示用的
        thisqid = 6;
        question_title.setText("5/5" + questionHashMap.get(thisqid));
        answerHashMap = GetDbUtils.getAnswerHashMap(GxmsActivityFive.this, thisqid);
    ...
    void gotonext() {
        ...
        individualJsonBean.setLstUserAnswer(MeiMengApplication.gxmsLstUserAnswer);
        Gson gson = new Gson();
    ...
    void jumpnext() {
        for (Activity activity : MeiMengApplication.GxmsManageActivity) {
            activity.finish();
        }
    }
                    ...
                    .subscribe(new Action1() {
                        ...
                        public void call(Object o) {
                            ...
                            if (basebean.isSuccess()) {
                                Toast.makeText(GxmsActivityFive.this, "提交成功", Toast.LENGTH_SHORT).show();
                                for (Activity activity : MeiMengApplication.GxmsManageActivity) {
                                    activity.finish();
                                }
                            } else {
                                DialogUtils.setDialog(GxmsActivityFive.this, basebean.getError());
                            }
                        }
                        ...
                        public void call(Throwable throwable) {
                            Log.e("GxmsActivityFive", throwable.getMessage());
                        }
                    });
        } catch (Exception e) {
            e.printStackTrace();
