 ...
 * 生活习惯3
 */
public class ShxgActivityThree extends BaseActivity {
 ...
 */
        thistype = 2;
        questionHashMap = GetDbUtils.getQuestionHashMap(ShxgActivityThree.this, thistype);
        //这部分只是界面展示用的
        thisqid = 9;
        question_title.setText("3/5" + questionHashMap.get(thisqid));
        answerHashMap = GetDbUtils.getAnswerHashMap(ShxgActivityThree.this, thisqid);
    ...
    void gotonext() {
        ...
        Intent intent = new Intent(this, ShxgActivityFour.class);
