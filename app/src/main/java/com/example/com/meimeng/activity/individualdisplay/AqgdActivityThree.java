 ...
 * 爱情观点3
 */
public class AqgdActivityThree extends BaseActivity {
 ...
 */
        thistype =3;
        questionHashMap = GetDbUtils.getQuestionHashMap(AqgdActivityThree.this, thistype);
        //这部分只是界面展示用的
        thisqid = 14;
        question_title.setText("3/5" + questionHashMap.get(thisqid));
        answerHashMap = GetDbUtils.getAnswerHashMap(AqgdActivityThree.this, thisqid);
    ...
    void gotonext() {
        ...
        Intent intent = new Intent(this, AqgdActivityFour.class);
