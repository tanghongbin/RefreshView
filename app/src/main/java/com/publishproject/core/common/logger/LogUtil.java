...
public final class LogUtil {
    private static String APP_TAG = LogUtil.class.getSimpleName();
    private static LoggerInterface loggerInterface;
    private static LogEnum logEnum = LogEnum.DEFAULT;
     ...
     * @param error      错误的详细信息
     */
    public static void detail(Class c, String methodName, String detail) {
        ...
        try{
            i(c.getSimpleName()+"  methodName:"+methodName+"  detail:"+detail);
        }catch (Exception e){
            e.printStackTrace();
        }finally {
