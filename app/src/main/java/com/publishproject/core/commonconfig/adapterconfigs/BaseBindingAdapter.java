package com.publishproject.core.commonconfig.adapterconfigs;
 ...
 *
 *
 *    BaseBindingAdapter adapter = new BaseBindingAdapter<Object,ViewDataBinding>(mContext,mList,mLayoutId){
 *        @Ovrride
